...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function buyTokens(address beneficiary) public nonReentrant payable virtual {
        ...
        _updateAddressStatus(beneficiary);
    }
    ...
    /**
     * @dev lock address for a period of time
     * @param beneficiary Address performing the token purchase
     */
    function _updateAddressStatus(address beneficiary) internal virtual returns(bool) {
        // nglLock.lockAddress(beneficiary);
        return true;
    }
